...
availability_rows (
  ...
  values
    ...
    ('77777777-7777-4777-8777-00000000070a'::uuid, '11111111-1111-4111-8111-00000000010b'::uuid, 'day_cover'::public.availability_slot_kind, 'Inshore Station', null::date, time '07:00', time '19:00', ARRAY[]::smallint[], false, true, 'DEMO DLA day cover.', now() + interval '1 hour', now() + interval '9 hours', '11111111-1111-4111-8111-000000000105'::uuid),
